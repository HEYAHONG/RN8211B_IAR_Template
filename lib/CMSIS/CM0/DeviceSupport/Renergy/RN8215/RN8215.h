...
#define __RN8215_H__
 ...
 extern "C" {
#endif 
/** @addtogroup RN8215_Definitions RN8215 Definitions
  This file defines all structures and symbols for RN8215:
...
/******************************************************************************/
/** @addtogroup RN8215_CMSIS Device CMSIS Definitions
...
/******  RN8215 Specific Interrupt Numbers ********************************************************/
...
/*@}*/ /* end of group RN8215_CMSIS */

#include "core_cm0.h"                       /* Cortex-M0 processor and core peripherals           */
#include "system_RN8215.h"                  /* RN8215 System  include file                      */


/******************************************************************************/
/*                Device Specific Peripheral registers structures             */
/******************************************************************************/
/** @addtogroup RN8215_Peripherals RN8215 Peripherals
  RN8215 Device Specific Peripheral registers structures
  @{
*/
...
typedef struct {
  ...
  __IO uint32_t RESERVED3[2] ;             /* offset 0x1a0~0x1a4  */
...
typedef struct {
  ...
  __IO uint32_t RESERVED[16];        /* offset = 0x38~0x74 */
...
#define CP_BASE                         (HSP_BASE + 0xC000                    )
